...
class ASMWorkReportPage extends StatefulWidget {
  const ASMWorkReportPage({super.key});

  @override
  State<ASMWorkReportPage> createState() => _ASMWorkReportPageState();
}

class _ASMWorkReportPageState extends State<ASMWorkReportPage> {
  ...
  Future<void> _loadEmployeeData() async {
    try {
      final id = await SessionManager.getEmpId();
  ...
  Future<void> _submitWorkReport() async {
    ...
    try {
      final report = ASMWorkReportModel(
        empId: empId!,
      ...
      final result = await _apiService.submitWorkReport(report);
      ...
      if (result) {
        ...
        _showMessage('Failed to submit work report. Please try again.', isError: true);
      }
    } catch (e) {
      debugPrint('❌ Work Report Submit Error: $e');
      if (!mounted) return;
      _showMessage(
        ...
        content: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Your ASM daily work report has been successfully recorded.',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${empName ?? 'ASM Manager'} • ID: ${empId ?? 'N/A'}',
                      maxLines: 1,
          ...
          Row(
            children: [
              _buildMetricItem('Total Visits', '$totalVisitsCount', Icons.medical_services_outlined),
              _buildDivider(),
                    ...
                    _buildSectionCard(
                      ...
                      children: [
                        ...
                        _buildCustomTextField(
                          ...
                          hint: 'e.g. Lucknow East, Hazratganj',
                        ),
                      ],
                    ),
                    ...
                    _buildSectionCard(
                      ...
                      children: [
                        _buildCustomTextField(
                          ...
                          hint: 'Number of doctor meetings',
                        ...
                        _buildCustomTextField(
                          ...
                          hint: 'Number of stockists visited',
                          keyboardType: TextInputType.number,
                        ),
                      ],
                    ),
                    ...
                    _buildSectionCard(
                      ...
                      children: [
                        ...
                        _buildCustomTextField(
                          ...
                          hint: 'e.g. Fuel allowance, DA, TA, meals',
                          required: false,
                          maxLines: 2,
                        ),
                      ],
                    ...
                    _buildSectionCard(
                      ...
                      children: [
                        _buildCustomTextField(
                          ...
                          hint: 'Summarize today\'s doctor interactions, product feedback, new schemes discussed, and market observations...',
                          maxLines: 4,
                        ),
                      ],
                    ),
