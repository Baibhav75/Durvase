...
import 'AsmAttendanceCheckOur.dart';
...
class AsmAttendancePage extends StatefulWidget {
  final TodoModel userData;
  final String userId;

  const AsmAttendancePage({super.key, required this.userData,
    required this.userId,});


  @override
  State<AsmAttendancePage> createState() => _AttendancePageState();
}

class _AttendancePageState extends State<AsmAttendancePage> {
  String _currentTime = "";
  String _currentDate = "";
  double? _latitude;
  double? _longitude;
  ...
  void _navigateToNextPage() {
    if (_attendanceManager.isCheckedIn) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => AsmAttendanceOutPage(
