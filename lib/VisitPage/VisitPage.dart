...
class _VisitpageState extends State<Visitpage> {
  ...
  Future<void> _loadVisitHistory() async {
    ...
    try {
      ...
      print('Loading visit history for mobile: $empMobile');
      ...
      print('✅ Loaded ${visitorsList?.length ?? 0} visits');
    } catch (e) {
      setState(() {
        isLoading = false;
        isRefreshing = false;
      ...
      print('❌ Error loading visit history: $e');
    }
  }
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              'Start a new visit for this customer?',
              style: GoogleFonts.poppins(
                fontSize: 14,
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    _showSnackBar(
                      'New visit started for ${visit.personName ?? 'customer'}',
                      Colors.green,
                    );
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'Search by business, customer, mobile...',
          ...
          children: [
            ...
            Text(
              _searchQuery.isNotEmpty
                  ? 'No visits found for "$_searchQuery"'
                  : selectedFilter == 'All'
